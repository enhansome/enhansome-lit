...
[Lit](https://github.com/lit/lit) ⭐ 21,801 | 🐛 722 | 🌐 TypeScript | 📅 2026-07-25 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,801 | 🐛 722 | 🌐 TypeScript | 📅 2026-07-25
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,801 | 🐛 722 | 🌐 TypeScript | 📅 2026-07-25
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,645 | 🐛 769 | 🌐 TypeScript | 📅 2026-09-01 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,645 | 🐛 769 | 🌐 TypeScript | 📅 2026-09-01 - Lit and TypeScript based template preset for Vite.
...
* [Vite Lit + Tailwind](https://github.com/lloydrichards/base_lit-with-tailwind) ⭐ 9 | 🐛 0 | 🌐 CSS | 📅 2025-10-18 - Modified Vite + Lit starter to use Tailwind v4.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 64 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-01 - Build Web Components with functional programming using Lit.
...
* [`pure-lit`](https://github.com/MatthiasKainer/pure-lit) ⭐ 25 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-28 - Register your Lit elements as pure functions.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,223 | 🐛 182 | 🌐 SCSS | 📅 2026-08-31 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,770 | 🐛 226 | 🌐 TypeScript | 📅 2026-09-01 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,535 | 🐛 236 | 🌐 TypeScript | 📅 2026-09-01 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,303 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-01 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 922 | 🌐 JavaScript | 📅 2026-09-01 - A set of high-quality web components for business web applications.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 212 | 🐛 50 | 🌐 SCSS | 📅 2026-09-01 - Set of UI components based on Momentum Design.
...
* [Wired Elements](https://github.com/rough-stuff/wired-elements) ⭐ 10,827 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Collection of elements that appear hand drawn.
...
* [ESP Web Tools](https://github.com/esphome/esp-web-tools) ⭐ 682 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-17 - Allow flashing ESPHome or other ESP-based firmwares via the browser.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 423 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-01 - Custom elements meet Apollo GraphQL.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 332 | 🌐 JavaScript | 📅 2026-09-01 - Collection of Web Components made by Clever Cloud.
* [M3E](https://github.com/matraic/m3e) ⭐ 202 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - Web Components implementing Material 3 Expressive.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 169 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-01 - Complete library of UI components from Infragistics.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 61 | 🌐 JavaScript | 📅 2026-08-30 - Web components used by TEI Publisher and apps generated by it.
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-01 - Ser of web components used by Equinor Fusion.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 8,220 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - A web component for rendering interactive 3D models.
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 7,053 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - Full featured JavaScript image and video gallery for Lit.
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 6,000 | 🐛 195 | 🌐 TypeScript | 📅 2026-08-26 - Block based editor, designed for general-purpose collaborative applications.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 793 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware shimmer skeleton loader that measures the real DOM to generate overlay blocks automatically.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-30 - Web component for rendering responsive images.
...
* [Web Component DevTools](https://github.com/Matsuuu/web-component-devtools) ⭐ 158 | 🐛 20 | 🌐 TypeScript | 📅 2025-12-08 - Browser extension for developers working with Web Components.
...
* [Fable.Lit](https://github.com/fable-compiler/Fable.Lit) ⭐ 96 | 🐛 16 | 🌐 F# | 📅 2023-02-12 - Collection of tools to embed HTML code into F# code with the power of Lit.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,040 | 🐛 105 | 📅 2026-08-21 list!**
