...
[Lit](https://github.com/lit/lit) ⭐ 21,790 | 🐛 719 | 🌐 TypeScript | 📅 2026-07-25 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,790 | 🐛 719 | 🌐 TypeScript | 📅 2026-07-25
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,790 | 🐛 719 | 🌐 TypeScript | 📅 2026-07-25
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,562 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-27 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,562 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-27 - Lit and TypeScript based template preset for Vite.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,206 | 🐛 181 | 🌐 SCSS | 📅 2026-08-27 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,771 | 🐛 223 | 🌐 TypeScript | 📅 2026-08-28 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,532 | 🐛 238 | 🌐 TypeScript | 📅 2026-08-28 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,299 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-27 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 924 | 🌐 JavaScript | 📅 2026-08-27 - A set of high-quality web components for business web applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-27 - Collection of web components for building Brightspace applications.
...
* [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) ⭐ 1,071 | 🐛 189 | 🌐 TypeScript | 📅 2026-08-27 - Collection of web components for the Microsoft Graph.
...
* [ESP Web Tools](https://github.com/esphome/esp-web-tools) ⭐ 681 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-17 - Allow flashing ESPHome or other ESP-based firmwares via the browser.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 200 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-28 - Web Components implementing Material 3 Expressive.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 8,215 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - A web component for rendering interactive 3D models.
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 7,050 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - Full featured JavaScript image and video gallery for Lit.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 789 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware shimmer skeleton loader that measures the real DOM to generate overlay blocks automatically.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-27 - Web component for rendering responsive images.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,606 | 🐛 105 | 📅 2026-08-21 list!**
