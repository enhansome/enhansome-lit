...
[Lit](https://github.com/lit/lit) ⭐ 21,772 | 🐛 717 | 🌐 TypeScript | 📅 2026-07-25 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,772 | 🐛 717 | 🌐 TypeScript | 📅 2026-07-25
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,772 | 🐛 717 | 🌐 TypeScript | 📅 2026-07-25
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,339 | 🐛 785 | 🌐 TypeScript | 📅 2026-08-13 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,339 | 🐛 785 | 🌐 TypeScript | 📅 2026-08-13 - Lit and TypeScript based template preset for Vite.
* [pwa-starter](https://github.com/pwa-builder/pwa-starter) ⭐ 1,326 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-16 - LitElement edition of the PWABuilder pwa-starter.
...
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,958 | 🐛 190 | 🌐 JavaScript | 📅 2026-08-11 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,770 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-13 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,529 | 🐛 234 | 🌐 TypeScript | 📅 2026-08-13 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,278 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-13 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 579 | 🐛 933 | 🌐 JavaScript | 📅 2026-08-13 - A set of high-quality web components for business web applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-13 - Collection of web components for building Brightspace applications.
...
* [Wired Elements](https://github.com/rough-stuff/wired-elements) ⭐ 10,821 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Collection of elements that appear hand drawn.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 190 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-12 - Web Components implementing Material 3 Expressive.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 59 | 🌐 JavaScript | 📅 2026-08-09 - Web components used by TEI Publisher and apps generated by it.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 8,194 | 🐛 116 | 🌐 TypeScript | 📅 2026-07-07 - A web component for rendering interactive 3D models.
...
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,974 | 🐛 194 | 🌐 TypeScript | 📅 2026-08-12 - Block based editor, designed for general-purpose collaborative applications.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 779 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware shimmer skeleton loader that measures the real DOM to generate overlay blocks automatically.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-13 - Web component for rendering responsive images.
...
* [`<helium-animated-pages>`](https://github.com/alangdm/helium-animated-pages) ⭐ 17 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-11 - Web component for creating CSS animations built with Lit.
...
* [cem](https://github.com/bennypowers/cem) ⭐ 46 | 🐛 10 | 🌐 Go | 📅 2026-08-10 - CLI multitool for generating, validating, and querying Custom Elements Manifests, with built-in LSP and MCP servers.
...
* [Fable.Lit](https://github.com/fable-compiler/Fable.Lit) ⭐ 95 | 🐛 15 | 🌐 F# | 📅 2023-02-12 - Collection of tools to embed HTML code into F# code with the power of Lit.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,369 | 🐛 99 | 📅 2026-06-30 list!**
