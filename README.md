...
[Lit](https://github.com/lit/lit) ⭐ 21,832 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-14 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,832 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-14
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,832 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-14
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,922 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-19 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,922 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-19 - Lit and TypeScript based template preset for Vite.
* [pwa-starter](https://github.com/pwa-builder/pwa-starter) ⭐ 1,341 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-16 - LitElement edition of the PWABuilder pwa-starter.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 64 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-19 - Build Web Components with functional programming using Lit.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,259 | 🐛 186 | 🌐 SCSS | 📅 2026-09-20 - Material Design implemented as Web Components.
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,963 | 🐛 170 | 🌐 JavaScript | 📅 2026-09-18 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,780 | 🐛 218 | 🌐 TypeScript | 📅 2026-09-20 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,537 | 🐛 243 | 🌐 TypeScript | 📅 2026-09-20 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,328 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-18 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 928 | 🌐 JavaScript | 📅 2026-09-20 - A set of high-quality web components for business web applications.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 213 | 🐛 53 | 🌐 SCSS | 📅 2026-09-19 - Set of UI components based on Momentum Design.
...
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,674 | 🐛 160 | 🌐 TypeScript | 📅 2026-08-21 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [ESP Web Tools](https://github.com/esphome/esp-web-tools) ⭐ 688 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-07 - Allow flashing ESPHome or other ESP-based firmwares via the browser.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 274 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-20 - Web Components implementing Material 3 Expressive.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 29 | 🐛 47 | 🌐 HTML | 📅 2026-09-20 - A schema for mutation testing results with the web components to visualize it.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-20 - Web components used by TEI Publisher and apps generated by it.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 8,250 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - A web component for rendering interactive 3D models.
...
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 6,018 | 🐛 196 | 🌐 TypeScript | 📅 2026-09-15 - Block based editor, designed for general-purpose collaborative applications.
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,898 | 🐛 139 | 🌐 JavaScript | 📅 2026-02-11 - Web Component to view OpenAPI 3.0 & Swagger 2.0 Spec.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - Web component for rendering responsive images.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,244 | 🐛 106 | 📅 2026-09-02 list!**
