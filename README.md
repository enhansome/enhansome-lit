...
[Lit](https://github.com/lit/lit) ⭐ 21,836 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-24 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,836 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-24
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,836 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-24
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,979 | 🐛 784 | 🌐 TypeScript | 📅 2026-09-24 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,979 | 🐛 784 | 🌐 TypeScript | 📅 2026-09-24 - Lit and TypeScript based template preset for Vite.
* [pwa-starter](https://github.com/pwa-builder/pwa-starter) ⭐ 1,346 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-16 - LitElement edition of the PWABuilder pwa-starter.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 64 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-24 - Build Web Components with functional programming using Lit.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,273 | 🐛 183 | 🌐 SCSS | 📅 2026-09-24 - Material Design implemented as Web Components.
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,964 | 🐛 172 | 🌐 JavaScript | 📅 2026-09-24 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,781 | 🐛 228 | 🌐 TypeScript | 📅 2026-09-24 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,539 | 🐛 247 | 🌐 TypeScript | 📅 2026-09-24 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,339 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-24 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 914 | 🌐 JavaScript | 📅 2026-09-24 - A set of high-quality web components for business web applications.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 214 | 🐛 52 | 🌐 SCSS | 📅 2026-09-24 - Set of UI components based on Momentum Design.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 50 | 🌐 JavaScript | 📅 2026-09-24 - Collection of web components for building Brightspace applications.
...
* [Wired Elements](https://github.com/rough-stuff/wired-elements) ⭐ 10,831 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Collection of elements that appear hand drawn.
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,680 | 🐛 160 | 🌐 TypeScript | 📅 2026-08-21 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 278 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-20 - Web Components implementing Material 3 Expressive.
...
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 7,053 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-23 - Full featured JavaScript image and video gallery for Lit.
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 6,023 | 🐛 196 | 🌐 TypeScript | 📅 2026-09-23 - Block based editor, designed for general-purpose collaborative applications.
...
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,178 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-17 - UI library for creating Web Components with simple and functional API.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,964 | 🐛 107 | 📅 2026-09-02 list!**
