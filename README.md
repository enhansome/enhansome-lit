...
[Lit](https://github.com/lit/lit) ⭐ 21,805 | 🐛 722 | 🌐 TypeScript | 📅 2026-07-25 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,805 | 🐛 722 | 🌐 TypeScript | 📅 2026-07-25
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,805 | 🐛 722 | 🌐 TypeScript | 📅 2026-07-25
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,657 | 🐛 765 | 🌐 TypeScript | 📅 2026-09-02 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,657 | 🐛 765 | 🌐 TypeScript | 📅 2026-09-02 - Lit and TypeScript based template preset for Vite.
...
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,960 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-02 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,771 | 🐛 230 | 🌐 TypeScript | 📅 2026-09-02 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,536 | 🐛 235 | 🌐 TypeScript | 📅 2026-09-02 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,303 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-02 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 927 | 🌐 JavaScript | 📅 2026-09-02 - A set of high-quality web components for business web applications.
...
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-02 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,667 | 🐛 156 | 🌐 TypeScript | 📅 2026-08-21 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 423 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02 - Custom elements meet Apollo GraphQL.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 331 | 🌐 JavaScript | 📅 2026-09-02 - Collection of Web Components made by Clever Cloud.
* [M3E](https://github.com/matraic/m3e) ⭐ 205 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - Web Components implementing Material 3 Expressive.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 169 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-02 - Complete library of UI components from Infragistics.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 8,222 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - A web component for rendering interactive 3D models.
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 7,054 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - Full featured JavaScript image and video gallery for Lit.
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 6,003 | 🐛 196 | 🌐 TypeScript | 📅 2026-09-02 - Block based editor, designed for general-purpose collaborative applications.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,403 | 🐛 105 | 📅 2026-09-02 list!**
