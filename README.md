...
[Lit](https://github.com/lit/lit) ⭐ 21,836 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-14 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,836 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-14
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,836 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-14
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,967 | 🐛 796 | 🌐 TypeScript | 📅 2026-09-23 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,967 | 🐛 796 | 🌐 TypeScript | 📅 2026-09-23 - Lit and TypeScript based template preset for Vite.
* [pwa-starter](https://github.com/pwa-builder/pwa-starter) ⭐ 1,345 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-16 - LitElement edition of the PWABuilder pwa-starter.
...
* [Vite Lit + Tailwind](https://github.com/lloydrichards/base_lit-with-tailwind) ⭐ 10 | 🐛 0 | 🌐 CSS | 📅 2025-10-18 - Modified Vite + Lit starter to use Tailwind v4.
* [Vite Lit + Intlayer](https://github.com/aymericzip/intlayer-vite-lit-template) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-22 - Per-component i18n solution for app and design-systems.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 64 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 - Build Web Components with functional programming using Lit.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,268 | 🐛 184 | 🌐 SCSS | 📅 2026-09-23 - Material Design implemented as Web Components.
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,964 | 🐛 171 | 🌐 JavaScript | 📅 2026-09-23 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,780 | 🐛 221 | 🌐 TypeScript | 📅 2026-09-23 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,539 | 🐛 253 | 🌐 TypeScript | 📅 2026-09-23 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,337 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-23 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 913 | 🌐 JavaScript | 📅 2026-09-23 - A set of high-quality web components for business web applications.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) ⭐ 214 | 🐛 53 | 🌐 SCSS | 📅 2026-09-23 - Set of UI components based on Momentum Design.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 48 | 🌐 JavaScript | 📅 2026-09-23 - Collection of web components for building Brightspace applications.
...
* [Wired Elements](https://github.com/rough-stuff/wired-elements) ⭐ 10,830 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Collection of elements that appear hand drawn.
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,679 | 🐛 160 | 🌐 TypeScript | 📅 2026-08-21 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 278 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-20 - Web Components implementing Material 3 Expressive.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents) ⭐ 274 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-23 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-23 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 170 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-23 - Complete library of UI components from Infragistics.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 72 | 🌐 JavaScript | 📅 2026-09-22 - Web components used by TEI Publisher and apps generated by it.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 8,256 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - A web component for rendering interactive 3D models.
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 7,054 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-23 - Full featured JavaScript image and video gallery for Lit.
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 6,022 | 🐛 196 | 🌐 TypeScript | 📅 2026-09-23 - Block based editor, designed for general-purpose collaborative applications.
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,899 | 🐛 139 | 🌐 JavaScript | 📅 2026-02-11 - Web Component to view OpenAPI 3.0 & Swagger 2.0 Spec.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-23 - Web component for rendering responsive images.
...
* [Web Component DevTools](https://github.com/Matsuuu/web-component-devtools) ⭐ 159 | 🐛 20 | 🌐 TypeScript | 📅 2025-12-08 - Browser extension for developers working with Web Components.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,449 | 🐛 106 | 📅 2026-09-02 list!**
