...
[Lit](https://github.com/lit/lit) ⭐ 21,797 | 🐛 721 | 🌐 TypeScript | 📅 2026-07-25 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,797 | 🐛 721 | 🌐 TypeScript | 📅 2026-07-25
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,797 | 🐛 721 | 🌐 TypeScript | 📅 2026-07-25
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,609 | 🐛 772 | 🌐 TypeScript | 📅 2026-08-30 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,609 | 🐛 772 | 🌐 TypeScript | 📅 2026-08-30 - Lit and TypeScript based template preset for Vite.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 64 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-28 - Build Web Components with functional programming using Lit.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,216 | 🐛 181 | 🌐 SCSS | 📅 2026-08-29 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,770 | 🐛 226 | 🌐 TypeScript | 📅 2026-08-30 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,535 | 🐛 233 | 🌐 TypeScript | 📅 2026-08-28 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,301 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-27 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 924 | 🌐 JavaScript | 📅 2026-08-28 - A set of high-quality web components for business web applications.
...
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,666 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-21 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 201 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-30 - Web Components implementing Material 3 Expressive.
...
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 7,052 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - Full featured JavaScript image and video gallery for Lit.
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,997 | 🐛 195 | 🌐 TypeScript | 📅 2026-08-26 - Block based editor, designed for general-purpose collaborative applications.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 791 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware shimmer skeleton loader that measures the real DOM to generate overlay blocks automatically.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 - Web component for rendering responsive images.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,448 | 🐛 105 | 📅 2026-08-21 list!**
