...
[Lit](https://github.com/lit/lit) ⭐ 21,767 | 🐛 718 | 🌐 TypeScript | 📅 2026-07-25 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,767 | 🐛 718 | 🌐 TypeScript | 📅 2026-07-25
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,767 | 🐛 718 | 🌐 TypeScript | 📅 2026-07-25
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 82,381 | 🐛 793 | 🌐 TypeScript | 📅 2026-08-17 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 82,381 | 🐛 793 | 🌐 TypeScript | 📅 2026-08-17 - Lit and TypeScript based template preset for Vite.
* [pwa-starter](https://github.com/pwa-builder/pwa-starter) ⭐ 1,327 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-16 - LitElement edition of the PWABuilder pwa-starter.
...
* [Vite Lit + Tailwind](https://github.com/lloydrichards/base_lit-with-tailwind) ⭐ 7 | 🐛 0 | 🌐 CSS | 📅 2025-10-18 - Modified Vite + Lit starter to use Tailwind v4.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 64 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - Build Web Components with functional programming using Lit.
...
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,175 | 🐛 178 | 🌐 SCSS | 📅 2026-08-17 - Material Design implemented as Web Components.
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,958 | 🐛 188 | 🌐 JavaScript | 📅 2026-08-17 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,770 | 🐛 218 | 🌐 TypeScript | 📅 2026-08-17 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,528 | 🐛 242 | 🌐 TypeScript | 📅 2026-08-17 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,283 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-14 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 579 | 🐛 930 | 🌐 JavaScript | 📅 2026-08-17 - A set of high-quality web components for business web applications.
...
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-17 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,652 | 🐛 153 | 🌐 TypeScript | 📅 2026-06-10 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [ESP Web Tools](https://github.com/esphome/esp-web-tools) ⭐ 679 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-17 - Allow flashing ESPHome or other ESP-based firmwares via the browser.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 393 | 🐛 171 | 🌐 TypeScript | 📅 2026-08-13 - Lightweight web components based on the PatternFly design system.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 194 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-16 - Web Components implementing Material 3 Expressive.
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 169 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-17 - Complete library of UI components from Infragistics.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 150 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-17 - Collection of user interface web components for Umbraco CMS.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-09 - Web components used by TEI Publisher and apps generated by it.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 8,201 | 🐛 116 | 🌐 TypeScript | 📅 2026-07-07 - A web component for rendering interactive 3D models.
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 7,047 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - Full featured JavaScript image and video gallery for Lit.
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,978 | 🐛 194 | 🌐 TypeScript | 📅 2026-08-14 - Block based editor, designed for general-purpose collaborative applications.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 784 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware shimmer skeleton loader that measures the real DOM to generate overlay blocks automatically.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-16 - Web component for rendering responsive images.
...
* [`<round-slider>`](https://github.com/thomasloven/round-slider) ⭐ 87 | 🐛 4 | 🌐 JavaScript | 📅 2024-09-27 - Simple round slider web component built with Lit.
...
* [`<helium-animated-pages>`](https://github.com/alangdm/helium-animated-pages) ⭐ 17 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-14 - Web component for creating CSS animations built with Lit.
...
* [Asimonim](https://github.com/bennypowers/asimonim) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2026-07-22 - Design tokens parser, validator, and language server for the W3C DTCG specification.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,969 | 🐛 102 | 📅 2026-06-30 list!**
